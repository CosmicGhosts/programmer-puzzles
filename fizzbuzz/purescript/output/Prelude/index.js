...
var showOrdering = new Show(function (_37) {
    ...
    throw new Error("Failed pattern match at /home/seanstrom/dev/oh-puzzles/fizzbuzz/purescript/bower_components/purescript-prelude/src/Prelude.purs line 850, column 1 - line 855, column 1: " + [ _37.constructor.name ]);
});
...
var showBoolean = new Show(function (_35) {
    ...
    throw new Error("Failed pattern match at /home/seanstrom/dev/oh-puzzles/fizzbuzz/purescript/bower_components/purescript-prelude/src/Prelude.purs line 828, column 1 - line 832, column 1: " + [ _35.constructor.name ]);
});
...
var semigroupOrdering = new Semigroup(function (_7) {
    return function (y) {
        ...
        throw new Error("Failed pattern match at /home/seanstrom/dev/oh-puzzles/fizzbuzz/purescript/bower_components/purescript-prelude/src/Prelude.purs line 412, column 1 - line 417, column 1: " + [ _7.constructor.name, y.constructor.name ]);
    };
});
...
var ordOrdering = new Ord(function () {
    ...
    return function (_27) {
        ...
        throw new Error("Failed pattern match at /home/seanstrom/dev/oh-puzzles/fizzbuzz/purescript/bower_components/purescript-prelude/src/Prelude.purs line 667, column 1 - line 676, column 1: " + [ _26.constructor.name, _27.constructor.name ]);
    };
});
        ...
        return function (ys) {
            return $dollar(compare(ordInt)(0))($foreign.ordArrayImpl(function (x) {
                return function (y) {
                    ...
                    throw new Error("Failed pattern match at /home/seanstrom/dev/oh-puzzles/fizzbuzz/purescript/bower_components/purescript-prelude/src/Prelude.purs line 659, column 1 - line 665, column 1: " + [ _46.constructor.name ]);
                };
            })(xs)(ys));
        };
    });
